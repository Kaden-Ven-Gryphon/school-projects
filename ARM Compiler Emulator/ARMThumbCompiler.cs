        ...
        private string decodeLiteral(string literal, int bits)
        {
            ...
            if(literal[0] == '#')
            {
                if(literal.Length > 1)
                {
                    ...
                    {
                        sb.Append(" no negative literals alowed ");
                    }
                    else
                    {
                        int buf = 0;
                        if (Int32.TryParse(literal.Substring(1), out buf))
                        {
                            if(buf < (Math.Pow(2.0, (double)bits)))
                            {
                                sb.Append(Convert.ToString(buf, 2));
                                for(int i = (bits - sb.Length); i > 0; i--)
                                {
                                    sb.Insert(0, '0');
                                }
                            }
                    ...
                    case "B":
                        if(numberOfTokens == 2)
                        {
                            ...
                            if(lb != null)
                            {
                                ...
                                {
                                    sb.Append(" jump to far for one branch, branch max is 2048 ");
                                }
                            }
                            else
                            {
                    ...
                    case "BEQ":
                        if (numberOfTokens == 2)
                        {
                            ...
                            if (lb != null)
                            {
                                ...
                                {
                                    sb.Append(" jump to far for one branch, branch max is 512 ");
                                }
                            }
                            else
                            {
                                ...
                                if(isData)
                                {
                                    if(dataLabels.Find(x => x.Name == tokens[0]) == null)
                                    {
                                        ...
                                        if (numberOfTokens == 2)
                                        {
                                            ...
                                            {
                                                Console.WriteLine("Line " + lineNumber + " missing value literal");
                                            }
                                        }
                                        else if (numberOfTokens == 3)
                                        {
                                        ...
                                        {
                                            Console.WriteLine("Line " + lineNumber + " invalid tokens");
                                        }
                                    }
                                    else
                                    {
                                        Console.WriteLine("Line " + lineNumber + " variable already exists");
                                    }
                                }
                                else
                                {
                                    ...
                                    {
                                        Console.WriteLine("Line " + lineNumber + " label already exists");
                                    }
                                }
                            }
                            else
                    ...
                    if(tokens.Length > 0)
                    {
                        if (tokens[0][0] != COMMENTCHAR)
                        {
                            ...
                            else
                            {
                                ...
                                machineCode.Add(toMachineString(line));
                                address += 2;
